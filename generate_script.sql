...
insert into readers (first_name, last_name, valid_til)
	select first_name, last_name, timestamp '2022-01-10 20:00:00' + random() * (timestamp '2025-01-20 20:00:00' - timestamp '2022-01-10 10:00:00')
	from tmp_readers;
